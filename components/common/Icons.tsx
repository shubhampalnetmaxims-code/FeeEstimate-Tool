...
export const HomeIcon = ({ className = 'h-6 w-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a.75.75 0 011.06 0l8.955 8.955M3 10.5v.75a3 3 0 003 3h1.5v3.75a.75.75 0 00.75.75h3.75a.75.75 0 00.75-.75V15h1.5a3 3 0 003-3v-.75M3 10.5l-1.5-1.5V12a1.5 1.5 0 001.5 1.5H3z" />
  </svg>
);
// FIX: Add and export MailIcon, LockIcon, EyeIcon, and EyeSlashIcon for reuse.
...
export const LockIcon = ({ className = 'h-6 w-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const ListBulletIcon = ({ className = 'h-6 w-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const UsersIcon = ({ className = 'h-6 w-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM10.5 18.75a9 9 0 00-7.5-3.839v-1.162a9 9 0 0115 0v1.162a9 9 0 00-7.5 3.839z" />
  </svg>
);
...
export const CogIcon = ({ className = 'h-6 w-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.008 1.11-1.226.55-.218 1.19-.243 1.74-.087.55.156 1.02.54 1.32 1.008.3.468.39.99.25 1.486l-.14.49a.63.63 0 00.36.72l.49.2a.63.63 0 01.43.66l-.08.52a.63.63 0 01-.6.5l-.54.08a.63.63 0 00-.52.54l-.08.54a.63.63 0 01-.5.6l-.52.08a.63.63 0 01-.66-.43l-.2-.49a.63.63 0 00-.72-.36l-.49-.14a.63.63 0 01-.48-.72l.14-.49c.14-.496.04-.99-.25-1.486a1.493 1.493 0 01-1.32-1.008c-.156-.55-.13-1.19.088-1.74.218-.55.668-1.02 1.226-1.11zM15 12a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
  );
export const ViewColumnsIcon = ({ className = 'h-6 w-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const WarningIcon = ({ className = 'h-6 w-6 text-red-600' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
